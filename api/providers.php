...
function providerDefinitions(): array {
    return [
        'linkedin'=>['id'=>'linkedin','name'=>'LinkedIn','clientIdLabel'=>'Client ID','clientSecretLabel'=>'Client Secret','defaultScopes'=>['openid','profile','w_member_social','r_organization_admin','w_organization_social'],'accountFields'=>['LinkedIn Account-ID'],'capabilities'=>['text'=>true,'image'=>true,'video'=>true,'document'=>true,'link'=>true]],
