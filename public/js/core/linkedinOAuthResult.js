...
export function oauthOutcomeText(result){const title=titles[result?.oauthErrorCategory]||titles.authorization;return result?.appName?`${result.appName}: ${title}`:title;}
