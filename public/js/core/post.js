...
export function createPost(values = {}) {
  ...
  return { id: values.id || createId("post"), baseText, link: values.link || "", linkTitle: values.linkTitle || "", linkDescription: values.linkDescription || "", media: Array.isArray(values.media)?values.media:[], selectedProviders:Array.isArray(values.selectedProviders)?values.selectedProviders:[], selectedChannels:Array.isArray(values.selectedChannels)?values.selectedChannels:[], variants, createdAt: values.createdAt || now, updatedAt: values.updatedAt||now, status: values.status || "draft" };
}
