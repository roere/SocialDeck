...
try{
    foreach(['003-text-blocks.sql','004-text-block-system-model.sql','005-email-settings.sql','006-social-channels.sql','007-publishing-attempts.sql','008-posts.sql','009-link-article-metadata.sql','010-media-assets.sql','011-campaigns.sql','012-provider-apps.sql'] as $name){
